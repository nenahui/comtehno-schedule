...
import { selectGroupsDeleting } from '@/features/groups/groupsSlice';
import { deleteGroup } from '@/features/groups/groupsThunks';
...
export const GroupsCard: React.FC<Props> = ({ group }) => {
  ...
  const groupsDeleting = useAppSelector(selectGroupsDeleting);
