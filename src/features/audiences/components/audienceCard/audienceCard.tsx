...
import { selectAudienceDeleting } from '@/features/audiences/audiencesSlice';
import { deleteAudience } from '@/features/audiences/audiencesThunks';
...
export const AudienceCard: React.FC<Props> = ({ audience }) => {
  ...
  const audienceDeleting = useAppSelector(selectAudienceDeleting);
